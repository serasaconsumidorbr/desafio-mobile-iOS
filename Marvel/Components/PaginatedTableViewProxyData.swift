//
//  PaginatedTableViewProxyData.swift
//  Marvel
//
...
@objc protocol InfiniteTableLoadable {
...
final class PaginatedTableViewProxyData: NSObject, UITableViewDataSource, UITableViewDelegate {

    typealias PaginatedDataSouce = UITableViewDataSource & InfiniteTableLoadable
    
    @objc enum States : Int {
        case none,
        infiniteLoading,
        retryError,
        pullLoading,
