...
protocol MarvelViewModelImpl {
    
    func getAllCharacters(page: Int?)
    
}

class MarvelViewModel : ObservableObject, MarvelViewModelImpl {
    
    private let repository : MarvelRepositoryImpl
    ...
    init(repository : MarvelRepositoryImpl) {
